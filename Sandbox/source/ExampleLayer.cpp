...
{
	m_VertexArray = CmHazel::VertexArray::Create();
...
void ExampleLayer::OnUpdate(CmHazel::Timestep ts)
{
	// 更新
	...
	for (int y = 0; y < 20; y++)
	{
		for (int x = 0; x < 20; x++)
		{
			...
			CmHazel::Renderer::Submit(m_FlatColorShader, m_SquareVA, transform);
		}
	}
...
void ExampleLayer::OnEvent(CmHazel::Event& event)
{
